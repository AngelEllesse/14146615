...
class ViewController: UIViewController, subviewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //makePlayer()
        playerImageView.myDelegate = self
    ...
    func changeSomething() {
        ...
        collisionBehavior.addBoundary(withIdentifier: "barrier" as
            NSCopying, for: UIBezierPath(rect: playerImageView.frame))
        
        for i in enemyViewArray{
            
            if (i.frame.intersects(self.playerImageView.frame) && self.score>0){
                print("collision")
    ...
    func timeOut(){
        ...
        let gameOver: UIImage = UIImage(named: "koopaPage.png")!
    ...
    func makeSky(){
        //load sky image
        let sky1: UIImage = UIImage(named: "sky.jpg")!
        ...
        //load sky2
        let sky2: UIImage = UIImage(named: "sky.jpg")!
